layui.use(['layer','table','form','upload'], function() {
    ...
    table.render({
        ...
        ,cols: [[ //表头  field: 'id'表示从实体对象的属性中取到数据放入容器里
            ...
            ,{field: 'firstANames', title: '角色权限', width:600,align:'center',templet:'#vipRateTpl'}
            ,{field: 'createDate', title: '创建时间', width:220, align:'center',sort: true}
            ,{field: 'status', title: '是否可用', width: 180, align:'center',sort: true,templet:'#statusTpl'}
            ,{field: 'flag', title: '是否显示', width: 240, align:'center',sort: true,templet:'#flagTpl'}
