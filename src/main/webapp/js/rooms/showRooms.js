layui.use(['jquery','layer','table','form','upload'], function() {
    ...
    $("#saveRoomsUI").click(function () {
        ...
        $("#demo1").attr("src","http://q6eehjkei.bkt.clouddn.com/fm1.jpg");
        $("#roomPicId").val("http://q6eehjkei.bkt.clouddn.com/fm1.jpg");
        //1.弹出添加界面
        layer.open({
            type:1,  //弹框类型
            title:"客房信息添加界面", //弹框标题
    ...
    var uploadInst = upload.render({
        ...
        ,accept:'file'  //允许上传的文件类型，file:所有文件类型
        ,size:500   //设置文件上传的最大值，单位：kb
